...
public class ChaosThread implements Runnable {
    ...
    private final ArrayList<String> chaosPlayers = new ArrayList<>();
    private Boolean spoilers = false;

    private final ChaosEvent[] chaosEvents = {
    ...
    public void run() {
        ...
        while(!thread.isInterrupted()) {
            try {
                ...
                // Enable
                chaosPlayers.forEach((player) -> new BukkitRunnable() {
                    public void run() {
